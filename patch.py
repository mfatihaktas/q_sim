...
dark_color = itertools.cycle(('green', 'red', 'blue', 'magenta', 'goldenrod', 'purple', 'gray', 'brown', 'goldenrod', 'gold', 'olive', 'orangered', 'silver', 'rosybrown', 'plum', 'lightsteelblue', 'lightpink', 'orange', 'turquoise', 'darkgray'))
